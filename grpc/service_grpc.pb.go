...
type ServiceCommunicatorClient interface {
	SendRandString(ctx context.Context, opts ...grpc.CallOption) (ServiceCommunicator_SendRandStringClient, error)
...
func (c *serviceCommunicatorClient) SendRandString(ctx context.Context, opts ...grpc.CallOption) (ServiceCommunicator_SendRandStringClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServiceCommunicator_ServiceDesc.Streams[0], "/proto.ServiceCommunicator/SendRandString", opts...)
	if err != nil {
		return nil, err
	}
	x := &serviceCommunicatorSendRandStringClient{stream}
	return x, nil
}

type ServiceCommunicator_SendRandStringClient interface {
	Send(*Message) error
	Recv() (*Message, error)
	grpc.ClientStream
}

type serviceCommunicatorSendRandStringClient struct {
	grpc.ClientStream
}

func (x *serviceCommunicatorSendRandStringClient) Send(m *Message) error {
	return x.ClientStream.SendMsg(m)
}

func (x *serviceCommunicatorSendRandStringClient) Recv() (*Message, error) {
	m := new(Message)
...
type ServiceCommunicatorServer interface {
	SendRandString(ServiceCommunicator_SendRandStringServer) error
...
func (UnimplementedServiceCommunicatorServer) SendRandString(ServiceCommunicator_SendRandStringServer) error {
...
func _ServiceCommunicator_SendRandString_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ServiceCommunicatorServer).SendRandString(&serviceCommunicatorSendRandStringServer{stream})
}

type ServiceCommunicator_SendRandStringServer interface {
	Send(*Message) error
	Recv() (*Message, error)
	grpc.ServerStream
}

type serviceCommunicatorSendRandStringServer struct {
	grpc.ServerStream
}

func (x *serviceCommunicatorSendRandStringServer) Send(m *Message) error {
	return x.ServerStream.SendMsg(m)
}

func (x *serviceCommunicatorSendRandStringServer) Recv() (*Message, error) {
	m := new(Message)
